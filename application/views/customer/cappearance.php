                	...
                	<div class="img_in">
						  ...
						  <?php }	?>
							...
							<tr>
                             ...
                             <tr>
                                  <td><input name="" type="text" class="in_box" />
								  <a href="#">
						...
						<div class="participation">
							...
							<input type="text" name="" class="new_in_box">
                                <a href="#">
								 ...
								 <!---<img alt="" src="/dev2013/referral/public/image/search_but.png" style=" float: left; margin: 0; padding: 4px;">---->
	
	                              <?php echo Html::image('public/image/search_but.png', array('alt'=>'', 'style'=>'float:left;margin:0; padding:4px;'));  ?>
...
<?php echo Html::image('public/image/in_i.jpg', array('alt'=>''));  ?>
			...
			<a href="<?php echo URL::base(); ?>/customer/cintegration/<?php echo $rpdid ?>" style="margin:0px; float:right;">
