    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <small>
                    <p>
                        Based in Montreal, Canada, the Lucky Referral team created this web service to first response to an internal need. The idea was to develop a tool that would enable us to run referral campaigns that would use all the latest technologies to growth our customer base. The results were astonishing!
                    </p>
                </small>
            </div>
            <!-- end: About -->
