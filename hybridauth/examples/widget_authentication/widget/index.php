...
<body>
    <div class="container">
        <div class="col-md-6 col-xs-6" style="border-right: 1px solid #808080">
            <div>

                <?php if (isset($img1)) { ?>
                    <img width="300px"
                         src="../../../../uploads/<?php echo $img1 ?>"
                         alt="Uploaded avatar"/>
                <?php } else { ?>
                    <img width="300px"
                         src="../../../../public/image/a.jpg"
                         alt="Uploaded avatar"/>
        ...
        <div class="col-md-6 col-xs-6">
            <div id="idps">
                <br><h4><?php echo "Enter for a chance to Win 2000$ cash!";//echo $refprogdesc; ?></h4><br>
                ...
                <table width="100%" border="0">
                  ...
                  <tr>
                    ...
                    <td align="center"><img class="idpico" idp="live" src="images/icons/myspace.png" title="live" /></td>
                ...
                <p class="tou">Read the CONTEST <b>term and conditions</b> before participating</p>
            </div>
