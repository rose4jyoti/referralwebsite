    ...
    if ( isset( $_GET["provider"])) {
        ...
        if (isset($_REQUEST["redirect_to_idp"])) {
            ...
            <table width="100%" border="0">
                <tr>
                    <td align="center" height="190px" valign="middle"><img src="<?php echo $imgRoot; ?>/loading.gif"/></td>
                </tr>
                <tr>
                    <td align="center"><br/>
            ...
            $(".idpico").click(
                function(){
                    ...
                    switch( idp ){
                        ...
                        $("#openidimg").attr( "src", "<?php echo $imgRoot; ?>/icons/" + idp + ".png" );
                        $("#idps").hide();
                        $("#openidid").show();
                        break;
                        case "openid" :
    ...
    <div class="col-md-6 col-xs-12 text-left" style="height: 473px; padding: 10px 15px 0px 15px; background-color: #EEEEEE">
        ...
        <div class="col-md-12" id="idps" style="background-color: #FFFFFF">
            ...
            <table style="width: 100%; border: 0px; background-color: #FFFFFF">
                <tr>
                    <td align="center"><img class="idpico" idp="live" src="<?php echo $imgRoot; ?>/icons/signin_outlook.png" title="live" /></td>
                    <td align="center"><img class="idpico" idp="google" src="<?php echo $imgRoot; ?>/icons/signin_gmail.png" title="google" /></td>
                </tr>
                <tr>
                    <td align="center"><img class="idpico" idp="yahoo" src="<?php echo $imgRoot; ?>/icons/signin_yahoo.png" title="yahoo" /></td>
                    <td align="center"><img class="idpico" idp="aol" src="<?php echo $imgRoot; ?>/icons/signin_aol.png" title="aol" /></td>
                </tr>
            </table>
            <br /> <br />
        </div>
        <div class="col-md-12" id="noProg" style="color:#f00000; display:none;">
            ...
            <table width="100%" border="0">
                <tr>
                    <td align="center"><img id="openidimg" src="<?php echo $imgRoot; ?>/loading.gif" /></td>
                </tr>
            </table>
            <br /><br /><br /><br /><br /><br />
